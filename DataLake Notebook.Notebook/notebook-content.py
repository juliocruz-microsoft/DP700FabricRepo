...
df.write.mode("overwrite").parquet("Files/bronze")
...
dfparquet = spark.read.format("parquet").load("Files/bronze")
display(dfparquet)
...
transformed_df = dfparquet.withColumn("Year", year(col("OrderDate"))).withColumn("Month", month(col("OrderDate")))
